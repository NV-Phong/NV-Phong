      ...
      text: (
        <div className="flex flex-col h-full">
          <p className="overflow-y-auto">
            ...
            possibilities where your wildest dreams can take flight. Join us
            today to embark on a journey of self-discovery, creativity, and
            endless inspiration—unleash the full potential of your imagination
