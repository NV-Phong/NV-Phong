...
const DATA = {
  navbar: [
    ...
    {
      href: "/ui-engineer",
      icon: () => <Icon styles="solid" name="software-license-solid-rounded" />,
      label: "UI Engineer",
    },
  ],
  contact: {
    social: {
      ...
      Facebook: {
        ...
        icon: () => <Icon styles="solid" name="facebook-02-solid-rounded" />,
      },
      Pinterest: {
        name: "Pinterest",
...
export function MagicUIDock() {
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50">
      <TooltipProvider>
        <Dock direction="bottom" iconDistance={0} className="bg-background/50">
              ...
              <TooltipTrigger asChild>
                <div className="size-12 flex items-center justify-center">
                  <Link href="/experience">
                    <Icon styles="solid" name="perplexity-ai-solid-rounded" />
                  </Link>
                </div>
              </TooltipTrigger>
              <TooltipContent>
              ...
              <TooltipTrigger asChild>
                <div className="size-12 flex items-center justify-center">
                  <Link href="/themes/color-visualizer">
                    <Icon styles="solid" name="paint-board-solid-rounded" />
                  </Link>
                </div>
              </TooltipTrigger>
              <TooltipContent>
