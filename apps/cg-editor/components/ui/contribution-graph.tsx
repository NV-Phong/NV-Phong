...
/** Map contribution count to level 0–4 for color scale */
   ...
   useEffect(() => {
      ...
      fetch(`/api/github-contributions?year=${year}`)
         ...
         .then((data: GitHubContributionsResponse) => {
            ...
            const { totalContributions: totalFromApi, weeks: apiWeeks } =
               calendar;
            ...
            // Build map date -> contribution count from API weeks
            ...
            // Build full year of days (Jan 1 .. Dec 31) so grid layout is correct
            ...
            while (currentDate <= endDate) {
               ...
               const count = countByDate.get(dateString) ?? 0;
            ...
            setStats({
               totalContributions: totalFromApi,
               currentStreak,
               longestStreak,
               bestDay,
            });
      ...
      <div className="w-full max-w-4xl mx-auto">
         ...
         {!isLoading && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
               <Card className="overflow-hidden shadow-2xl shadow-primary/15">
         ...
         <div className="relative">
            {isLoading ? (
               ...
               <Card className="overflow-hidden p-6 shadow-2xl shadow-primary/15">
                  <p className="text-sm text-destructive font-medium">
                     Không tải được dữ liệu
                  </p>
                  <p className="text-sm text-neutral-500 mt-1">{fetchError}</p>
               </Card>
            ) : (
               <Card className="overflow-hidden p-0 shadow-2xl shadow-primary/15">
