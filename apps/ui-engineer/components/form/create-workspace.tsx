   ...
   return (
      <>
         {open &&
            createPortal(
               <div
                  className="fixed inset-0 bg-background/30 backdrop-blur-[10px] z-[99]"
         ...
         <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent
               className="w-80 mr-4 bg-background z-[100] relative"
               side="right"
               align="start"
               sideOffset={5}
            >
               <form onSubmit={handleSubmit} className="grid gap-4">
                  <div className="space-y-2">
                     ...
                     <p className="text-sm text-muted-foreground">
                        Create a new workspace to manage your notes and
                        schedule.
                     </p>
                  </div>
