      ...
      <fieldset className="flex h-8 p-0 m-0 rounded-[999999px] border border-shadow">
         ...
         <div className="mt-[-1px] ml-[-1px]">
            ...
            <label
               ...
               className={clsx(
                  "flex items-center justify-center h-8 w-8 cursor-pointer rounded-[999999px] group border-r",
                  theme === "system" ? "border-shadow" : "border-transparent",
               )}
            >
               ...
               >
                  <path
                     ...
                     className={clsx(
                        "group-hover:fill-foreground duration-150",
                        theme === "system"
                           ? "fill-foreground"
                           : "fill-foreground/50",
                     )}
         ...
         <div className="mt-[-1px]">
            ...
            <label
               ...
               className={clsx(
                  "flex items-center justify-center h-8 w-8 cursor-pointer rounded-[999999px] group border",
                  theme === "light" ? "border-shadow" : "border-transparent",
               )}
            >
         ...
         <div className="mt-[-1px] mr-[-1px]">
            ...
            <label
               ...
               className={clsx(
                  "flex items-center justify-center h-8 w-8 cursor-pointer rounded-[999999px] group border-l",
                  theme === "dark" ? "border-shadow" : "border-transparent",
               )}
            >
