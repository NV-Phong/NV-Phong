                        ...
                        <div className="space-y-3">
                           ...
                           <div className="space-y-1">
                              <Separator textPosition="start">
                                 <Label className="-ml-2">My Interests</Label>
                              </Separator>
                     ...
                     <CardFooter className="flex flex-col p-0">
                        ...
                        <div className="w-full font-semibold flex justify-between mt-5">
                           <Button
                              ...
                              className="bg-transparent p-0 hover:bg-transparent dark:bg-transparent dark:hover:bg-transparent border-none text-gray-950 underline decoration-primary dark:decoration-primary-foreground-1 underline-offset-3 hover:decoration-2 dark:text-white"
                           >
