...
const checkpointNotes: CheckpointNote[] = [
   {
      ...
      text: (
         <div className="flex flex-col gap-2">
            <div className="space-y-1">
               <Separator textPosition="center">Role</Separator>
            ...
            <div className="flex justify-center">
               <ViewDetailButton slug="tam-phuc" className="w-full" />
            </div>
         </div>
      ),
      month: "Feb",
      year: "2026",
      timeAgo: "10 days ago",
      href: "/my-work/tam-phuc",
      stackedNotes: [
         {
            id: "note-5-stack-1",
            title: "TamPhuc Website",
            text: "A corporate website that showcases furniture products such as lockers and storage cabinets while introducing the company and its business.",
            timeAgo: "10 days ago",
         },
      ],
   },
   {
      ...
      text: (
         <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-center">
               <ViewDetailButton slug="memorymud" className="w-full" />
            </div>
         </div>
      ),
      month: "Jan",
      ...
      href: "/my-work/memorymud",
      stackedNotes: [
         {
            id: "note-6-stack-1",
            title: "Memorymud",
            text: "A showcase website for ceramic products and memory-preservation services, where personal memories can be stored and revisited through NFC chips and fortune cookies.",
            timeAgo: "2 months ago",
         },
      ],
   },
   {
      ...
      text: (
         <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-center">
               <ViewDetailButton slug="phu-vinh-phi" className="w-full" />
            </div>
         </div>
      ),
      month: "Dec",
      ...
      href: "/my-work/phu-vinh-phi",
      stackedNotes: [
         {
            id: "note-7-stack-1",
            title: "PhuVinhPhi Website & Zalo Mini App",
            text: "A corporate website that showcases products and machine repair services while introducing the company and its expertise.",
            timeAgo: "3 months ago",
         },
      ],
   },
   {
      ...
      text: (
         <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-center">
               <ViewDetailButton slug="gom-thu-duc" className="w-full" />
            </div>
         </div>
      ),
      month: "Nov",
      ...
      href: "/my-work/gom-thu-duc",
      stackedNotes: [
         {
            id: "note-8-stack-1",
            title: "GomThuDuc Website",
            text: "A showcase website for ceramic products, pottery courses, and hands-on workshops.",
            timeAgo: "4 months ago",
         },
      ],
   },
   {
      ...
      text: (
         <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-center">
               <ViewDetailButton slug="viemind" className="w-full" />
            </div>
         </div>
      ),
      month: "Oct",
      ...
      href: "/my-work/viemind",
      stackedNotes: [
         {
            id: "note-9-stack-1",
            title: "VieMind Website",
            text: "A corporate website designed to present the company’s vision, services, and expertise, helping businesses showcase their capabilities, build credibility, and connect with potential clients and partners.",
            timeAgo: "5 months ago",
         },
      ],
   },
   {
      ...
      text: (
         <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-center">
               <ViewDetailButton slug="cg-editor" className="w-full" />
            </div>
         </div>
      ),
      month: "May",
   ...
   },
   {
      ...
      text: (
         <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-center">
               <ViewDetailButton slug="workspacex" className="w-full" />
            </div>
         </div>
      ),
      month: "Mar",
   ...
   },
   {
      ...
      text: (
         <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-center">
               <ViewDetailButton slug="ui-engineer" className="w-full" />
            </div>
         </div>
      ),
      month: "Dec",
   ...
   },
   {
      ...
      text: (
         <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-center">
               <ViewDetailButton slug="pingme" className="w-full" />
            </div>
         </div>
      ),
      month: "Nov",
...
export default function Timeline() {
   ...
   return (
      <div className="">
         <div className="relative" style={{ minHeight: `${timelineHeight}px` }}>
            ...
            >
               <div className="flex flex-col items-center">
                  <div className="text-primary-foreground-darker flex flex-col justify-center items-center font-semibold mb-5">
                     PRESENT
                  </div>
                  <Icon
                     styles="solid"
                     ...
                     <div key={`checkpoint-group-${index}`}>
                        ...
                        <motion.div>
                           <StickyNote
                              ...
                              initialX={
                                 notePositions[note.id]?.x || initialPos.x
                              }
                              initialY={
                                 notePositions[note.id]?.y || initialPos.y
                              }
                        ...
                        {note.stackedNotes.map((stackedNote, stackIndex) => {
                           const stackedInitialPos = {
                              x: initialPos.x + (stackIndex + 1) * 8,
                              y: initialPos.y - (stackIndex + 1) * 6,
                           };
                           const stackedPos = {
                              x:
         ...
         <code className="mb-5 -mt-10 flex justify-center">
