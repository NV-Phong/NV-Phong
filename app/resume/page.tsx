        ...
        <div className="flex flex-col items-center justify-center">
          <div className="mb-9 max-w-7xl mx-auto relative z-10 w-full pt-20 md:pt-0 text-center">
            ...
            <p className="font-normal text-base dark:text-primary/60 light:text-neutral-900 max-w-3xl mx-auto">
              I&apos;m on a journey to become a Full-Stack developer. With my
              knowledge of UI/UX design. I enjoy solving Front-End problems and
              creating the best user experience for users. I also spend time
              learning new technologies and best practices to become a better
              engineer. I like to learn about process automation or applying AI
